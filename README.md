...
| --- | --- | --- | --- |
| `public/data/github.json` | repo stats, latest release, contributors, recent commits | `scripts/fetch-github-data.mjs` | `refresh-data.yml` (weekly) |
...
| `refresh-data.yml` | weekly | regenerate the GitHub snapshot (PR when changed) |
